...
public class BasicParallelStreams {
    ...
    public static void main(String[] args) {
        ...
        // sooper fast nu streams
        printDivider("parallel streaming");

        start = currentTimeMillis();
        List<Double> resultWithParallelStreams = parallelStream_sqRtEvenNumbers(createIntList(1_000));
        end = currentTimeMillis() - start;


        System.out.println(resultWithParallelStreams);
        System.out.println("took: " + end + "ms\n");
        System.out.println(result.equals(resultWithParallelStreams) ? "result was the same" : "results differed");
    }
    ...
    private static List<Double> parallelStream_sqRtEvenNumbers(List<Integer> source) {
